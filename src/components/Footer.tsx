      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">GreenGuide</span>
            </Link>
            <p className="text-gray-400 mb-4">
              Helping cities become greener, one tree at a time.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/recommendations" className="text-gray-400 hover:text-green-400 transition-colors">
        ...
        <div className="pt-8 mt-8 border-t border-gray-800 text-center">
          <p className="text-gray-500">
            © {currentYear} GreenGuide. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
